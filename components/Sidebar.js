...
function Sidebar() {
  return (
    <div className="hidden sm:flex flex-col items-center xl:items-start xl:w-[340px] p-2 fixed h-full">
      ...
      >
        <img
          src="https://img.seadn.io/files/80616debe1ec357bb98e96dd2024b57d.png?h=1024&w=1024&auto=format"
          alt="me"
          className="h-10 w-10 rounded-full xl:mr-2.5 text-white"
        />
        <div className="hidden xl:inline leading-5">
          <h4 className="font-bold">PaperHand_nft</h4>
          <p className="text-[#6e767d]">@PaperHand_nft</p>
        </div>
